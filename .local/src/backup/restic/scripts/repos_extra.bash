...
# Logfile location
# -------------------------------------------------------------------------------
logFile="${REPOSITORY_ROOT_DIR}/logs/restic_extra.log"
...
# -------------------------------------------------------------------------------
export RESTIC_REPOSITORY="${REPOSITORY_ROOT_DIR}/repos/Extra"
...
declare -a BACKUP_TARGETS=( "${BACKUP_ROOT_DIR}/Pictures" "${BACKUP_ROOT_DIR}/Videos" "${BACKUP_ROOT_DIR}/Music" "${BACKUP_ROOT_DIR}/Downloads" )
# Specify tags for backup targets in above array
declare -a BACKUP_TAGS=( "Extra_Pics" "Extra_Vids" "Extra_Music" "Extra_Downloads" )
# Specify exclude file location(with exclude patterns) for backup targets in above array
EXCLUDE_FILES=( "" --exclude-file="${BACKUP_ROOT_DIR2}/Videos/backup_excludes.txt" "" "" )
