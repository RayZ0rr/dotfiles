...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUD.bash started" | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUD.bash backup completed, starting forget ..." | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUD.bash forget completed, starting prune ..." | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUD.bash prune completed, starting check ..." | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUD.bash finished" | tee -a "${logFile}"
