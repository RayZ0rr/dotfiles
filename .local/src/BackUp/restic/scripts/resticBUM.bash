...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUM.bash started" | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUM.bash backup completed, starting forget ..." | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUM.bash forget completed, starting prune ..." | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUM.bash prune completed, starting check ..." | tee -a "${logFile}"
...
printf "\n\n"
echo "-------------------------------------------------------------------------------" | tee -a "${logFile}"
echo "$(timestamp): resticBUM.bash finished" | tee -a "${logFile}"
