        ...
        PanelWindow {
            ...
            Item {
                ...
                Row {
                    ...
                    readonly property real rightX: Math.max(0, (this.centerX + this.width + root.commonSpacing) - rightGroup.x)
                    readonly property real leftX: Math.max(0, (leftGroup.x + leftGroup.width + root.commonSpacing) - this.centerX)
