                ...
                Loader {
                    ...
                    sourceComponent: Component {
                        Rectangle {
                            ...
                            Text {
                                color: "green"
                                text: SystemTray.items.values[1].id
                            }
                            Image {
                                source: SystemTray.items.values[1].icon
                            }
                            // PopupWindow {
                            //     id: win_pop
                            //     anchor.window: toplevel
                            ...
                            QsMenuAnchor {
                                id: sys_menu
                                menu: SystemTray.items.values[1].menu
                                // anchor.window: win_pop
                                anchor.window: sys_rect.QsWindow.window
                            }
                            MouseArea {
                                anchors.fill: parent
                                onClicked: {
                                    sys_menu.open()
                                    // SystemTray.items.values[0].display(sys_menu, 0, 0)
                                    // SystemTray.items.values[1].activate()
                                    // SystemTray.items.values[0].secondaryActivate()
                                    // SystemTray.items.values[0].display(win_pop, 0, 0)
                                }
                            }
                        }
                    }
